--[[
This script was written by DarkKobold, and is part of the
FBA-rr 0.0.4.02 distribution:

http://adelikat.tasvideos.org/emulatordownloads/fbaRR/fba-rr-v0.0.4.02.zip

I do not own, and do not claim any ownership over this original
implementation. I am [temporary] hosting this file
in my github so you can compare my modified script version
to the original
--]]
